...
public class ro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service = findViewById(R.id.servicechargero);
        install = findViewById(R.id.installchargero);
        repair = findViewById(R.id.repairchargero);
        save = findViewById(R.id.savebuttonro);

        DatabaseReference ref = database.getReference("providers/ro");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ro.this, "Data Saved", Toast.LENGTH_SHORT).show();
            }
        });
